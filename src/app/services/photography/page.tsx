...
const OTHER = [
  ...
  { label: 'GRAPHIC DESIGN', href: '/services/graphic-design', emoji: '✏️' },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <p className="leading-relaxed mb-6" style={{ color: '#F5EFE0', fontFamily: "'Livvic', sans-serif", fontSize: '1rem', lineHeight: 1.8 }}>
                Event, brand, and product photography that captures the moment and elevates your presence. Every shoot is golden-hour worthy.
              </p>
              <ul className="flex flex-col gap-3">
                {['Event & wedding photography', 'Brand & headshot sessions', 'Product photography', 'Social media content shoots', 'Lifestyle photography'].map((item) => (
            ...
            <div className="rounded-2xl p-8 flex flex-col gap-5" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }}>
              ...
              <div style={{ color: '#F5EFE0', fontFamily: "'Livvic', sans-serif" }}>
                <p className="font-bold text-lg">Starting at $400/session</p>
                <p className="text-sm mt-1" style={{ opacity: 0.75 }}>Edited gallery delivered within 1–2 weeks</p>
              </div>
              <Link
                href="/#vision"
