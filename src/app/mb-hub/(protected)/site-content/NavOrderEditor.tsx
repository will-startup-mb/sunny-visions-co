  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-5">
        <div className="w-1 h-5 rounded-full flex-shrink-0" style={{ backgroundColor: '#F26522' }} />
      ...
      <div className="pl-4 space-y-4">
        <div className="card p-5">
          <p className="text-xs text-gray-400 mb-4">
            Drag the arrows to reorder sidebar nav items. Changes take effect on next page load.
          </p>
          <ol className="space-y-1.5">
            {items.map((item, i) => (
              ...
              >
                <span className="flex-1 text-sm font-medium" style={{ color: '#1B3A52' }}>
                  {item.label}
                </span>
          ...
          <div className="flex items-center gap-3 mt-4">
            <button
              ...
              style={{ backgroundColor: saved ? '#3A9E9E' : '#1B3A52' }}
            >
