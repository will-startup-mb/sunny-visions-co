...
export default function SecurityPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 md:space-y-8">
      <div>
        <h1 className="text-xl font-extrabold" style={{ color: '#3D2B1F' }}>Security</h1>
      ...
      {status === 'enabled' && (
        <div className="card p-6 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm" style={{ color: '#3D2B1F' }}>Two-factor authentication is enabled</p>
      ...
      {status === 'confirm' && (
        <div className="card p-6 space-y-5">
          <div>
            <p className="font-semibold text-sm mb-1" style={{ color: '#3D2B1F' }}>1. Scan this QR code</p>
          ...
          <form onSubmit={verifyAndEnable} className="space-y-3">
            <div>
              <p className="font-semibold text-sm mb-2" style={{ color: '#3D2B1F' }}>2. Enter the 6-digit code to confirm</p>
              <input
                type="text"
                inputMode="numeric"
                pattern="[0-9 ]*"
      ...
      {status === 'done' && (
        <div className="card p-6 text-center space-y-3">
          ...
          <p className="font-semibold" style={{ color: '#3D2B1F' }}>Two-factor authentication enabled!</p>
