  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#F8F9FA' }}>
      ...
      <main className="flex-1 max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto w-full px-6 pt-12 pb-24">
        <h1 className="text-4xl font-extrabold mb-6" style={{ color: '#1B3A52' }}>{c.about_page_title}</h1>

        <p className="text-gray-600 text-lg leading-relaxed mb-4">{c.about_intro}</p>
        <p className="text-gray-600 text-lg leading-relaxed mb-12">{c.about_will_bio}</p>

        <div className="space-y-10">
          <section>
            <h2 className="text-2xl font-bold mb-3" style={{ color: '#1B3A52' }}>{c.about_directory_heading}</h2>
            <div className="w-10 h-1 rounded-full mb-4" style={{ backgroundColor: '#3A9E9E' }} />
            <p className="text-gray-600 leading-relaxed">{c.about_directory_body}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-3" style={{ color: '#1B3A52' }}>{c.about_podcast_heading}</h2>
            <div className="w-10 h-1 rounded-full mb-4" style={{ backgroundColor: '#F26522' }} />
            <p className="text-gray-600 leading-relaxed">{c.about_podcast_body}</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-3" style={{ color: '#1B3A52' }}>{c.about_mission_heading}</h2>
            <div className="w-10 h-1 rounded-full mb-4" style={{ backgroundColor: '#1B3A52' }} />
            <p className="text-gray-600 leading-relaxed">{c.about_mission_body}</p>
          </section>
        </div>
        ...
        <div className="mt-14 pt-10 border-t border-gray-200">
          ...
          <div className="flex items-center gap-6 mb-10">
            {c.about_linkedin_will_url && (
              <a href={c.about_linkedin_will_url} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 transition-opacity hover:opacity-70">
            ...
            {c.about_linkedin_company_url && (
              <a href={c.about_linkedin_company_url} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 transition-opacity hover:opacity-70">
            ...
            {c.about_instagram_url && (
              <a href={c.about_instagram_url} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 transition-opacity hover:opacity-70">
