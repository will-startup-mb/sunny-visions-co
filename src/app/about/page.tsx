      ...
      <main className="flex-1 max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto w-full px-6 pt-12 pb-24">
        ...
        <div className="flex items-center gap-6 mb-12">
          ...
          >
            ...
            <span className="text-xs font-medium" style={{ color: '#3A9E9E' }}>Will&apos;s LinkedIn</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs font-medium" style={{ color: '#3A9E9E' }}>Startup MB</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs font-medium" style={{ color: '#3A9E9E' }}>Instagram</span>
          </a>
        </div>
